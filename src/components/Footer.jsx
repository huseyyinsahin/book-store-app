...
export default () => {
  return (
    <footer className="mt-10 border-t border-gray text-gray-500 bg-white px-4 py-5 max-w-screen-xl mx-auto md:px-8">
      <div className="max-w-lg sm:mx-auto sm:text-center">
        <NavLink
          to="/"
          className="md:ml-32 ml-16 text-black flex align-items-center justify-content-center"
        >
          <IoBookOutline className=" sm:mt-0 text-5xl" />
          <p
            className="ml-3 mt-2 sm:mt-2"
        ...
        <p className="text-center leading-relaxed mt-2 text-[15px]">
          ‘’ Sevdiğiniz çiçek, milyonlarca yıldızdan yalnız birinde bile bulunsa
          yıldızlara bakmak mutluluğunuz için yeterlidir. ‘’
        </p>
      </div>

      <div className=" items-center justify-between sm:flex">
        <div className="mt-4 text-center sm:mt-0">2024 © Hüseyin Şahin</div>
